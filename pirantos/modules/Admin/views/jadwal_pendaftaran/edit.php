                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Update Jadwal Pendaftaran</h5> 
                                        <a href="<?php echo base_url('admin/jadwal_pendaftaran/add') ?>" class="btn shadow-2 btn-success pull-right">Add Data</a> 
                                        ...
                                        <div class="card-block"> 
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <input type="date" class="form-control" value="" name="date_sending">
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-sm-12 col-xs-12">
