                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Jadwal Pendaftaran</a></li>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Add Jadwal Pendaftaran</h5>
                                        <a href="<?php echo base_url('admin/jadwal_pendaftaran/add') ?>"
                                            class="btn shadow-2 btn-success pull-right">Add</a>
                                        <a href="<?php echo base_url('admin/jadwal_pendaftaran/data') ?>"
                                        ...
                                        <div class="card-block">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <input id="imgInp" type="file" name="foto_file2"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <textarea id="body" name="about_us" class="form-control"
    ...
    $(function () {
        ...
        function uploadFile(file) {
            ...
            $.ajax({
                data: data,
                type: "POST",
                url: "<?php echo base_url('admin/jadwal_pendaftaran/upload_img_summernote') ?>",
                cache: false,
                contentType: false,
                processData: false,
        ...
        $('#input_data').on('submit', function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/jadwal_pendaftaran/insert_content') ?>",
                cache: false,
                ...
                success: function (data) {
                    if (data.msg == 'success') {
                        ...
                        setTimeout(function () {
                            window.location =
                                "<?php echo base_url('admin/jadwal_pendaftaran') ?>";
                        }, 2000)
