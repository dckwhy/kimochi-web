                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Detail Jadwal Pendaftaran</h5> 
                                        <a href="<?php echo base_url('admin/jadwal_pendaftaran/add') ?>" class="btn shadow-2 btn-success pull-right">Add</a> 
                                        <a href="<?php echo base_url('admin/jadwal_pendaftaran/data') ?>" class="btn shadow-2 btn-primary pull-right">Data</a> 
                                    </div>
                                    <?php 
                                        ...
                                        <div class="card-block"> 
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <input type="file" name="foto_file_first" class="form-control" disabled>
                                                <!-- <?php
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <input type="date" class="form-control" value="" name="date_sending" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-sm-12 col-xs-12">
