                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Jadwal Tes</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">
                                            <i class="feather icon-user"></i></a></li>
                                    <li class="breadcrumb-item"><a href="javascript:">Jadwal Tes</a></li>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Update Jadwal Tes</h5>
                                        <a href="<?php echo base_url('admin/jadwal_tes/add') ?>"
                                            class="btn shadow-2 btn-success pull-right">Add Data</a>
                                        <a href="<?php echo base_url('admin/jadwal_tes/data') ?>"
                                            class="btn shadow-2 btn-primary pull-right">Data</a>
                                    </div>
                                    <?php 
                                    $id = $this->uri->segment(4);
                                    $this->db->where('id', $id);
                                    $row = $this->db->get('data_jadwal_test')->row();
                                    ?>
                                    <form id="input_data">
                                        <div class="card-block">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <?php
                                                    if(@$row->img){
                                                        $src = base_url('prabotan/image/jadwal_tes/'.@$row->img);
                                                    } else {
                                                        $src = '#';
                                                    }
                                                    ?>
                                                    <img src="<?= $src ?>" alt="" id="preview"
    ...
    $(document).ready(function () {
        ...
        function uploadFile(file) {
            ...
            $.ajax({
                data: data,
                type: "POST",
                url: "<?php echo base_url('admin/jadwal_tes/upload_img_summernote') ?>",
                cache: false,
                contentType: false,
                processData: false,
        ...
        $('#input_data').on('submit', function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/jadwal_tes/edit_data') ?>",
                cache: false,
                ...
                success: function (data) {
                    if (data.msg == 'success') {
                        ...
                        setTimeout(function () {
                            window.location =
                                "<?php echo base_url('admin/jadwal_tes') ?>";
                        }, 2000)
                    } else {
