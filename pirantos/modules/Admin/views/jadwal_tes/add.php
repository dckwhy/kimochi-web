                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Add Jadwal Tes</h5> 
                                        <a href="<?php echo base_url('admin/jadwal_tes/add') ?>" class="btn shadow-2 btn-success pull-right">Add Data</a> 
                                        <a href="<?php echo base_url('admin/jadwal_tes/data') ?>" class="btn shadow-2 btn-primary pull-right">Data</a> 
                                    </div>
                                    <form id="input_data">
...
<script>
    $(function() {
        ...
        $('#input_data').on('submit', function (e) {
            ...
            $.ajax({
                type :"post",  
                url : "<?php echo base_url('admin/jadwal_tes/insert_content') ?>",  
                cache :false,
                ...
                success : function(data) {
                    if (data.msg == 'success') {
                        ...
                        setTimeout(function(){
                            window.location = "<?php echo base_url('admin/jadwal_tes') ?>";
                        },2000)
