                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="nama_accessories" value="<?php echo @$row->nama_accessories ?>"placeholder="Nama Accessories" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        <label>Kategori</label> 
                                                        <input type="text" class="form-control" name="kategori" value="<?php echo @$row->kategori ?>" placeholder="Kategori" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        <label>Merk</label> 
                                                        <input type="text" class="form-control" name="merk" value="<?php echo @$row->merk ?>" placeholder="Merk" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        <label>Harga Pokok</label> 
                                                        <input type="text" class="form-control" name="harga_pokok" value="<?php echo @$row->harga_pokok ?>" placeholder="Harga Pokok" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        <label>Harga Jual</label> 
                                                        <input type="text" class="form-control" name="harga_jual" value="<?php echo @$row->harga_jual ?>" placeholder="Harga Jual" required>
                                                    </div>
                                                </div>
    ...
    $(document).ready(function () {
        ...
        function uploadFile(file) {
            ...
            $.ajax({
                data: data,
                type: "POST",
                url: "<?php echo base_url('admin/accessories/upload_img_summernote') ?>",
                cache: false,
                contentType: false,
                processData: false,
        ...
        $('#input_data').on('submit', function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/accessories/edit_data') ?>",
                cache: false,
                ...
                success: function (data) {
                    if (data.msg == 'success') {
                        ...
                        setTimeout(function () {
                            window.location =
                                "<?php echo base_url('admin/accessories') ?>";
                        }, 2000)
                    } else {
