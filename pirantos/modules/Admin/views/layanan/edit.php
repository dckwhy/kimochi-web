                                        ...
                                        <div class="card-block"> 
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        <label>Harga</label>
                                                        <input type="text" class="form-control" required name="harga" value="<?php echo @$row->harga ?>" placeholder="harga">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
   ...
   $(document).ready(function () {
       ...
       function uploadFile(file) {
           ...
           $.ajax({
               data: data,
               type: "POST",
               url: "<?php echo base_url('admin/layanan/upload_img_summernote') ?>",
               cache: false,
               contentType: false,
               processData: false,
       ...
       $('#input_data').on('submit', function (e) {
        e.preventDefault();
                    ...
                    $.ajax({
                       type: "post",
                       url: "<?php echo base_url('admin/layanan/edit_data') ?>",
                       cache: false,
