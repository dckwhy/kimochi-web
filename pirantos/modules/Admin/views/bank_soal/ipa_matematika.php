                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                   <li class="breadcrumb-item"><a href="#">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Matematika</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
function get_detail (id) {  
    window.location = ('<?= base_url() ?>admin/Bank_soal/detail_ipa_matematika/'+id)
}
function get_edit (id) {
    window.location = ('<?= base_url() ?>admin/Bank_soal/edit_ipa_matematika/'+id) 
}
</script>
<script>
...
function act_delete(id){
    ...
    $.ajax({
        type :"post",  
        url : "<?php echo base_url('admin/Bank_soal/delete_data') ?>",  
        cache :false,
