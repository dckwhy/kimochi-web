                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Detail Users</h5> 
                                        <a href="<?php echo base_url('admin/users/tambah') ?>" class="btn shadow-2 btn-success pull-right">Add</a> 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="position" value="<?php echo @$row->position ?>" placeholder="Position" required disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="previlege" value="<?php echo @$row->previlege ?>" placeholder="Privilege" required disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
