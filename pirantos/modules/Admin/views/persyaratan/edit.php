                                        ...
                                        <div class="card-block">
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <?php
                                                    if(@$row->img){
                                                        $src = base_url('prabotan/image/img-persyaratan/'.@$row->img);
                                                    } else {
                                                        $src = '#';
                                                    }
                                                    ?>
    ...
    $(document).ready(function () {
        ...
        function uploadFile(file) {
            ...
            $.ajax({
                data: data,
                type: "POST",
                url: "<?php echo base_url('admin/persyaratan/upload_img_summernote') ?>",
                cache: false,
                contentType: false,
                processData: false,
        ...
        $('#input_data').on('submit', function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/persyaratan/edit_data') ?>",
                cache: false,
